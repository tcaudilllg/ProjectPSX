...
namespace ProjectPSX.Devices {
    ...
    public class CDROM {
        ...
        public uint load(Width w, uint addr) {  // get status info from CD drive
            switch (addr) {
                case 0x1F801800:
        ...
        public void write(Width w, uint addr, uint value) {
            ...
            // allows system to interact with CD drive
        ...
        private void setLoc() {
            ...
            // Check if this is a different file than was last read from
            if (Loc != (Globals.lastCDSector + 1)) Globals.differentFile = true;
