...
namespace ProjectPSX {
    ...
    public class BUS : DMA_Transfer {
        ...
        public Int32[] GTE_RAMAssoc = new Int32[2048 * 1024];  // remember program counter addresses that use GTE to process RAM
        public Int32[] CDSector_RAMAssoc = new Int32[2048 * 1024];  // remember which sectors were read to what RAM
